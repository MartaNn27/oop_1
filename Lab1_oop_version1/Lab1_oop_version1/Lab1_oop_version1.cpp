 //На основі контейнера set побудувати множину з унікальними
//елементами. Продемонструвати операції об’єднання, різниці, перетину,
//відношення, перевірки входження елемента у множину, введення –
//виведення множин
#include <iostream>
#include <set>
#include <iterator>
